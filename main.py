...
def create_app():
    ...
    forecasting_model = WEATHER_FORECAST_MODEL(temperature, irradiance, wind_speed)
    ...
    def get_forecasts():
        ...
        assert now <= then <= now + timedelta(hours=48), "then value should be between now value and now + 48 hours"
